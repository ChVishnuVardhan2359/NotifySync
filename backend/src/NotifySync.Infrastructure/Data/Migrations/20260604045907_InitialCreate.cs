        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CallTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SmsMessages_Devices_DeviceId",
                        column: x => x.DeviceId,
                        principalTable: "Devices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CallLogs_UserId_CallTime",
                table: "CallLogs",
                columns: new[] { "UserId", "CallTime" });

            migrationBuilder.CreateIndex(
                name: "IX_CallLogs_UserId_SourceKey",
                table: "CallLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SmsMessages_UserId_MessageTime",
                table: "SmsMessages",
                columns: new[] { "UserId", "MessageTime" });

            migrationBuilder.CreateIndex(
                name: "IX_SmsMessages_UserId_SourceKey",
                table: "SmsMessages",
                columns: new[] { "UserId", "SourceKey" });
